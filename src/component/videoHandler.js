    ...
    render() { 
        ...
        return ( 
            <div className="container mx-auto">
                ...
                <iframe className="center px-10 py-5" src="https://drive.google.com/file/d/1t1jgAAyzVhsPvEhIsWarSFabzVO8GCRE/preview" width="640" height="480"></iframe>
                <iframe className="center px-10 py-5" src="https://drive.google.com/file/d/1DjLNWfjcxxRDxUHHdejbcUFW9bPLSpbo/preview" width="640" height="480"></iframe>
            </div>
         );
    }
}
